// path: frontend/src/features/parties/components/PartiesTable.tsx
...
import type { Party } from "../api/parties.api";
...
export function PartiesTable({ rows, onEdit }: Props) {
  const columns = useMemo<ColumnDef<Party>[]>(
    () => [
      ...
      },
      {
        ...
        header: () => <div className="text-right">Cr Limit</div>,
        size: 100,
        cell: (c) => (
